...
export type ElementId = BuiltInElementId | TextElementId | DeviceElementId;
...
/** theme = project theme gradient; solid / gradient use bgColor */
export type BgStyle = "theme" | "solid" | "gradient";
